...
from .views import (
    Login, Logout, CadastroView, 
    RequestEmail, CheckToken, SetNewPassword, 
    NotificationsView, PerfilView, AlterarSenhaView)
...
urlpatterns = [
    ...
    path('perfil/alterarsenha/', AlterarSenhaView.as_view(), name='alterar_senha'),
