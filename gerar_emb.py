...
df = pd.read_csv("etapas_limpa.csv")

# 2. Pega os textos
textos = df["etapas_processadas"].dropna().tolist()
...
vectorstore.save_local("faiss_etapas_index")
print("✅ Embeddings gerados e índice salvo em 'faiss_etapas_index/'")