    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.welcomeBox}>
        <Text style={styles.welcomeText}>
          Bem-vindo à aba de Score! Aqui você se desafia a se tornar um cidadão
          mais atento, engajado e consciente das propostas públicas.
        </Text>
      </View>
      ...
      <View style={styles.unifiedBox}>
        ...
        <View style={styles.levelsListBlack}>
          ...
          <Text style={styles.levelCurrentBlack}>
            Nível 4: Cidadão Participativo
          </Text>
          <Text style={styles.levelLockedBlack}>
            🔒 Nível 6: Construtor de Vozes
          </Text>
          <Text style={styles.levelLockedBlack}>
            🔒 Nível 7: Guardião do Debate
          </Text>
          <Text style={styles.levelLockedBlack}>
            🔒 Nível 8: Conselheiro Político
          </Text>
          <Text style={styles.levelLockedBlack}>
            🔒 Nível 9: Líder Comunitário
          </Text>
          <Text style={styles.levelLockedBlack}>
            🔒 Nível 10: Mestre Cívico
          </Text>
        </View>
      </View>
    </ScrollView>
