...
export default function ConsultaScreen() {
 ...
 useEffect(() => {
  ...
  const fetchConsultas = async () => {
    try {
      const response = await fetch(`https://14becbe8f935.ngrok-free.app/consultas/${id}/`, {
        headers: {
  ...
  try {
    const res = await fetch(`https://14becbe8f935.ngrok-free.app/consultas/favoritas/`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
const toggleFavorito = async () => {
  try {
    const res = await fetch(`https://14becbe8f935.ngrok-free.app/consultas/toggle/${id}/`, {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${token}`,
      },
